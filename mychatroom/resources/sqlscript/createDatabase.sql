...
(
    group_account         varchar(20) not null, # 群号
    group_name            varchar(20) not null, # 群名
...
(
    user        varchar(20) not null, # 当前用户账号
    friend_user varchar(20) not null, # 该用户好友账号
    realtion    varchar(20) not null  # 两人的关系(特别关心,黑名单,普通)
);
...
(
    ...
    send_can_look int         not null, # 发送者是否能查看
    recv_can_look int         not null  # 接收者是否能查看
);
